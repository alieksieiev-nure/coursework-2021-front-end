...
class LocationOwnerData extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        fetch(baseUrl + "LocationOwner/Get", {
            method: 'GET',
            headers: {
    ...
    removeData(event) {
        ...
        fetch(baseUrl + "LocationOwner/Delete", {
            method: 'DELETE',
        ...
        window.location.href = "/locationownerdata";
    }
    ...
    updateData(event) {
        ...
        fetch(baseUrl + "LocationOwner/Update", {
            method: 'PUT',
            body: JSON.stringify(payload),
            headers: {
                'Accept': 'application/json, text/plain, */*',
    ...
    addNewData(event) {
        ...
        fetch(baseUrl + "LocationOwner/Post", {
            method: 'POST',
            body: JSON.stringify(payload),
            headers: {
                'Accept': 'application/json, text/plain, */*',
                            ...
                            <Form onSubmit={(event) => this.removeData(event)}>
                                <ModalBody>
                                    <Row className="form-group">
                                        <Label htmlFor="userId" md={12}>{local.acceptRemoveMessage}</Label>
                                        <Col md={8}>
                                            <Input
                                                id="userId"
                                                name="userId"
...
export default LocationOwnerData;