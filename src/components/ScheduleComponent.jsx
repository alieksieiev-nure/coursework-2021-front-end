...
class ScheduleManager extends Component {
        ...
        fetch(baseUrl + "Schedule/GetScheduleByUser?userToken=" + Cookies.get('secutiryToken'), {
            ...
            .then(
                (response) => {
                    ...
                    this.setState({
                        selectedLocationId: this.state.data[0].locationId
                    });
                }
            );
    }
    ...
    removeData(event) {
        ...
        fetch(baseUrl + "Schedule/DeleteByManager?scheduleId=" + this.state.selectedId + "&userToken=" + Cookies.get('secutiryToken'), {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json, text/plain, */*',
                'Content-Type': 'application/json; charset=UTF-8'
